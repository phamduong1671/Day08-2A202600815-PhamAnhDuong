...
if __name__ == "__main__":
    ...
    results = semantic_search("hình phạt cho tội tàng trữ ma tuý", top_k=5)
    for r in results:
        print(f"[{r['score']:.3f}] {r['content'][:100]}...")store.
"""
Task 5 — Semantic Search Module.
...
if __name__ == "__main__":
    ...
    results = semantic_search("hình phạt cho tội tàng trữ ma tuý", top_k=5)
    for r in results:
        print(f"[{r['score']:.3f}] {r['content'][:100]}...")Task 4
"""
Task 5 — Semantic Search Module.
...
if __name__ == "__main__":
    ...
    results = semantic_search("hình phạt cho tội tàng trữ ma tuý", top_k=5)
    for r in results:
        print(f"[{r['score']:.3f}] {r['content'][:100]}...")dex
"""
Task 5 — Semantic Search Module.
...
if __name__ == "__main__":
    ...
    results = semantic_search("hình phạt cho tội tàng trữ ma tuý", top_k=5)
    for r in results:
        print(f"[{r['score']:.3f}] {r['content'][:100]}...") → similarity
"""
Task 5 — Semantic Search Module.
...
if __name__ == "__main__":
    ...
    results = semantic_search("hình phạt cho tội tàng trữ ma tuý", top_k=5)
    for r in results:
        print(f"[{r['score']:.3f}] {r['content'][:100]}...")tuý", top_k=5)
"""
Task 5 — Semantic Search Module.
